...
from source.utils.manage_device import get_device
...
class SentenceBERT:
    ...
    def __new__(cls, model_name="sentence-transformers/all-MiniLM-L6-v2", cache_dir=".cache", allow_accelerator=True):
        if cls._instance is None:
            cls._instance = super().__new__(cls)
            cls._instance._registered_names = []
            cls._instance.device = get_device(allow_accelerator=allow_accelerator)
